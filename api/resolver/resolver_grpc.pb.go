...
type ResolverClient interface {
	Resolve(ctx context.Context, in *Question, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *resolverClient) Resolve(ctx context.Context, in *Question, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type ResolverServer interface {
	Resolve(context.Context, *Question) (*Response, error)
...
func (UnimplementedResolverServer) Resolve(context.Context, *Question) (*Response, error) {
...
func _Resolver_Resolve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResolverServer).Resolve(ctx, req.(*Question))
	}
